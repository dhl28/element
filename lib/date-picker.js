          ...
          _vm._l(_vm.rows, function(row, key) {
            return _c(
              "tr",
              {
                ...
                class: {
                  current: _vm.isWeekActive(row[_vm.showWeekNumber ? 1 : 0])
                }
              },
              _vm._l(row, function(cell, key) {
...
/* harmony default export */ var date_tablevue_type_script_lang_js_ = ({
    ...
    rows: function rows() {
      ...
      for (var i = 0; i < 6; i++) {
        ...
        if (this.showWeekNumber) {
          row[0] = { type: 'week', text: Object(date_util_["getWeekNumber"])(this.getDateOfCell(i, 1)) };
        }
        ...
        if (this.selectionMode === 'week') {
          ...
          var isWeekActive = this.isWeekActive(row[start]);
  ...
  methods: {
    ...
    isWeekActive: function isWeekActive(cell) {
      ...
      if (Object(date_util_["isDate"])(this.value)) {
        var dayOffset = (this.value.getDay() - this.firstDayOfWeek + 7) % 7;
